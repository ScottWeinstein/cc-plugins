# S-Tier Design Checklist (Inspired by Stripe, Airbnb, Linear)
...
- [ ] **Choose a Scalable CSS Methodology:**
  - [x] **Utility-First (Recommended for LLM):** e.g., Tailwind CSS. Define design tokens in config, apply via utility classes.
